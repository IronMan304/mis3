...
class ServiceRequest extends Model
{
    ...
    protected $fillable = [ 'service_id', 'borrower_id', 'staff_user_id', 'tool_id', 'status_id', 'source_id', 'operator_id', 'set_date', 'description', 'user_id', 'tool_status_id', 'request_number' ];
