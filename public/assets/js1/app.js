...
$(document).ready(function($) {
	...
	if($('#msg_list2').length > 0) {
		$('#msg_list2').slimscroll({
			height: '100%',
			color: '#878787',
			disableFadeOut: true,
			borderRadius: 0,
		...
		var msgHeight = $(window).height() - 124;
		$('#msg_list2').height(msgHeight);
		$('.msg-sidebar .slimScrollDiv').height(msgHeight);
		$(window).resize(function() {
			var msgrHeight = $(window).height() - 124;
			$('#msg_list2').height(msgrHeight);
			$('.msg-sidebar .slimScrollDiv').height(msgrHeight);
		});
	}

	if($('#msg_list3').length > 0) {
		$('#msg_list3').slimscroll({
			height: '100%',
			color: '#878787',
			disableFadeOut: true,
			borderRadius: 0,
		...
		var msgHeight = $(window).height() - 124;
		$('#msg_list3').height(msgHeight);
		$('.msg-sidebar .slimScrollDiv').height(msgHeight);
		$(window).resize(function() {
			var msgrHeight = $(window).height() - 124;
			$('#msg_list3').height(msgrHeight);
			$('.msg-sidebar .slimScrollDiv').height(msgrHeight);
		});
	}

	if($('#msg_list4').length > 0) {
		$('#msg_list4').slimscroll({
			height: '100%',
			color: '#878787',
			disableFadeOut: true,
			borderRadius: 0,
		...
		var msgHeight = $(window).height() - 124;
		$('#msg_list4').height(msgHeight);
		$('.msg-sidebar .slimScrollDiv').height(msgHeight);
		$(window).resize(function() {
			var msgrHeight = $(window).height() - 124;
			$('#msg_list4').height(msgrHeight);
			$('.msg-sidebar .slimScrollDiv').height(msgrHeight);
		});
	}

	if($('#msg_list5').length > 0) {
		$('#msg_list5').slimscroll({
			height: '100%',
			color: '#878787',
			disableFadeOut: true,
			borderRadius: 0,
		...
		var msgHeight = $(window).height() - 124;
		$('#msg_list5').height(msgHeight);
		$('.msg-sidebar .slimScrollDiv').height(msgHeight);
		$(window).resize(function() {
			var msgrHeight = $(window).height() - 124;
			$('#msg_list5').height(msgrHeight);
			$('.msg-sidebar .slimScrollDiv').height(msgrHeight);
		});
	}
	...
	$(document).on('click', '#open_msg_box1', function() {
		$wrapper.toggleClass('open-msg-box1');
		return false;
	});
